...
async function signUpUser(userData) {
  try {
    ...
    await topRightSwal("Account created successfully");

    return user;
  } catch (error) {
    topRightSwal(`Something happened while signing up ${error}`, "error");
              ...
              if (res) {
                passConfirm($("#confirmPassword").val().value).then((res) => {
                  if (res) {
                        ...
                        uniIdConfirm($("#uniId").val()).then((res) => {
                          if (res) {
                            ferqaConfirm($("#ferqa").val().value).then(
                              (res) => {
                                if (res) {
                                  qesmConfirm($("#qesm").val().value).then(
                                    (res) => {
                                      if (res) {
                                        const userData = {
                                          email: encryptData(
                                  ...
                                  topRightSwal("يرجى اختيار الفرقة", "error");
                                  $("#ferqa").focus();
                    ...
                    topRightSwal("عذراً كلمتا المرور غير متطابقتان!", "error");
